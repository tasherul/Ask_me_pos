...
class RestaurantFoodMenuController extends Controller
{
    ...
    {
        $menu = RestaurantFoodMenu::with('categoryInfo', 'creatorInfo')->where('restaurant_id', Auth::guard('restaurantUser')->user()->restaurant_id)->where('del_status', 'Live')->orderBy('updated_at', 'desc')->get();
    ...
    public function create()
    {
        ...
        // return $categories;
        return view('pages.restaurant.sale.foodMenu.create', compact('code', 'categories', 'ingredients', 'shifts', 'panels', 'vats'));
    }
