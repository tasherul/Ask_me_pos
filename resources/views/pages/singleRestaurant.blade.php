                            ...
                            <li class="" id="reservation_left_content" style="display:none;" > 
                                <div class="box-grey rounded" style="margin-top:0;">
                                    ...
                                    <form class="forms has-validation-callback" id="frm-book" action="{{route('table.reservation')}}" method="POST">
                                        ...
                                        <div class="row top10"> 
                                            <div class="col-md-3 "> Date Of Booking </div> 
                                            <div class="col-md-3 "> 
                                                <input class="datepicker grey-inputs" required="required" data-id="booking_date" type="text" value="" name="booking_date" id="booking_date"> 
                                            </div>
                                        </div> <!--row--> 
                                        <div class="row top10"> 
                                            <div class="col-md-3 "> Time Of Booking </div> 
                                            <div class="col-md-3 "> 
                            ...
                            <form action="{{route('customer.checkout')}}" method="post">
                                ...
                                <div class="inner line-top relative delivery-option center"> 
                                    ...
                                    <select class="grey-fields" name="order_type" id="delivery_option">
                                        ...
                                        <option value="2" @if ($delivery_option == 'pickup') selected @endif>Pickup</option>
                                    </select> 
        ...
        <div class="modal-body">
            <form id="add_food_menu_to_cart" method="POST" action="#">
                ...
                <div class="row">
                    <div class="col">
                        <h5>Price:</h5>
                        <p class="small">Take Away: $<span id="take_away_price">150</span></p>
                        <p class="small">Delivery: $<span id="delivery_price">100</span></p>
                    </div>
                </div>
                <hr>
                <div class="row">
