...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/jquery.slimscroll.min.js"></script>
        <!-- Sweet alert -->
            ...
            <div class="top_header_part fix">
                ...
                <div class="header_part_right fix">
                    ...
                    <div class="header_single_button_holder" style="width:14%;">
                        <a href="#" id="register_close"><button style="float:right;" disabled><i class="fas fa-times"></i> Register</button></a>
                    </div> 
                            ...
                            <div class="select_category_inside_inside">
                                ...
                                @if ($categories)
                                    @foreach ($categories as $category)
                                        <button class="category_button" id="button_category_{{$category->id}}" style="border-left: solid 2px #DEDEDE;">{{$category->name}}</button>
                                    @endforeach
                                @endif
                            </div>
            ...
            <div class="modal-content">
                ...
                <div style="margin: 0 5px;">
                    ...
                    <div class="section7 fix">
                        <div class="sec7_inside" id="sec7_2"><button id="add_to_cart">add_to_cart</button></div>
