                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary" href="{{route('suppliers.create')}}">Add Supplier
                                </a>
                            </div>
                                    ...
                                    @foreach($suppliers as $k=>$v)
                                        <tr>
                                            <td class="text-center">
                                                <label>
                                                    <input type="checkbox" class="supplier"  name="select_supplier[]" value="{{$v->id}}">
                                                </label><br>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                                        ...
                                                        <a class="dropdown-item delete-supplier" role="button" data-id="{{$v->id}}">Delete</a> |
                ...
                <form id="supplier_message_form">
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <label><input type="checkbox" name="text_email[]" value="SMS Message"> SMS Message</label><br>
                            </div>
                    </div>
